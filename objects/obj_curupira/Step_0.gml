...
if (timer_poder <= 0 && morto == false)
{
    ...
    var poder = instance_create_layer(x, y, "inimigos", obj_poder_curupira);
    poder.direction = direcao_para_jogador;  
    poder.speed = 2;  // Velocidade do poder

    // Alinhar a imagem com a direção calculada
    poder.image_angle = poder.direction; 

    // Resetando o temporizador para 3 segundos
    timer_poder = 3 * room_speed; 
}
else
{
    timer_poder--; 
...
// Lógica para fazer o curupira rir aleatoriamente
